...
public class DummyControllerTest {
    ...
    public User updateUser(@PathVariable int id, @RequestBody User requestUser) {    //json 데이터를 요청 => Java Object(MessageConverter의 Jackson 라이브러리가 변환해서 받아줌)로 변환해서 받아줌
    ...
    //hhtp의 body에 username, password, email 데이터를 가지고 (요청)
